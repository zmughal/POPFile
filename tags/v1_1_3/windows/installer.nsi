...
Section /o "XMLRPC" SecXMLRPC
  ...
  File "${C_PERL_DIR}\lib\HTTP\Cookies.pm"
  ...
  File "${C_PERL_DIR}\lib\HTTP\Negotiate.pm"
  ...
  File "${C_PERL_DIR}\lib\HTTP\Cookies\Microsoft.pm"
  File "${C_PERL_DIR}\lib\HTTP\Cookies\Netscape.pm"

  SetOutPath "$G_MPLIBDIR\HTTP\Headers"
  File "${C_PERL_DIR}\lib\HTTP\Headers\Auth.pm"
  File "${C_PERL_DIR}\lib\HTTP\Headers\ETag.pm"
  File "${C_PERL_DIR}\lib\HTTP\Headers\Util.pm"

  SetOutPath "$G_MPLIBDIR\HTTP\Request"
  File "${C_PERL_DIR}\lib\HTTP\Request\Common.pm"

  SetOutPath "$G_MPLIBDIR\LWP"
  File "${C_PERL_DIR}\lib\LWP\ConnCache.pm"
  File "${C_PERL_DIR}\lib\LWP\Debug.pm"
  File "${C_PERL_DIR}\lib\LWP\DebugFile.pm"
  File "${C_PERL_DIR}\lib\LWP\media.types"
  File "${C_PERL_DIR}\lib\LWP\MediaTypes.pm"
  File "${C_PERL_DIR}\lib\LWP\MemberMixin.pm"
  File "${C_PERL_DIR}\lib\LWP\Protocol.pm"
  File "${C_PERL_DIR}\lib\LWP\RobotUA.pm"
  File "${C_PERL_DIR}\lib\LWP\Simple.pm"
  File "${C_PERL_DIR}\lib\LWP\UserAgent.pm"

  SetOutPath "$G_MPLIBDIR\LWP\Authen"
  File "${C_PERL_DIR}\lib\LWP\\Authen\Basic.pm"
  File "${C_PERL_DIR}\lib\LWP\\Authen\Digest.pm"
  File "${C_PERL_DIR}\lib\LWP\\Authen\Ntlm.pm"

  SetOutPath "$G_MPLIBDIR\LWP\Protocol"
  File "${C_PERL_DIR}\lib\LWP\\Protocol\cpan.pm"
  File "${C_PERL_DIR}\lib\LWP\\Protocol\data.pm"
  File "${C_PERL_DIR}\lib\LWP\\Protocol\file.pm"
  File "${C_PERL_DIR}\lib\LWP\\Protocol\ftp.pm"
  File "${C_PERL_DIR}\lib\LWP\\Protocol\GHTTP.pm"
  File "${C_PERL_DIR}\lib\LWP\\Protocol\gopher.pm"
  ...
  File "${C_PERL_DIR}\lib\LWP\\Protocol\loopback.pm"
  File "${C_PERL_DIR}\lib\LWP\\Protocol\mailto.pm"
  File "${C_PERL_DIR}\lib\LWP\\Protocol\nntp.pm"
  File "${C_PERL_DIR}\lib\LWP\\Protocol\nogo.pm"

  SetOutPath "$G_MPLIBDIR\Net"
  File "${C_PERL_DIR}\lib\Net\HTTP.pm"
  File "${C_PERL_DIR}\lib\Net\HTTPS.pm"

  SetOutPath "$G_MPLIBDIR\Net\HTTP"
  File "${C_PERL_DIR}\lib\Net\HTTP\Methods.pm"
  File "${C_PERL_DIR}\lib\Net\HTTP\NB.pm"
  ...
  File "${C_PERL_DIR}\lib\XML\Simple.pm"

  SetOutPath "$G_MPLIBDIR\XML\Parser"
  File "${C_PERL_DIR}\lib\XML\Parser\Expat.pm"
  File "${C_PERL_DIR}\site\lib\XML\Parser\Lite.pm"
  File "${C_PERL_DIR}\lib\XML\Parser\LWPExternEnt.pl"
  ...
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\big5.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\euc-kr.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\ibm866.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\iso-8859-2.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\iso-8859-3.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\iso-8859-4.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\iso-8859-5.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\iso-8859-7.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\iso-8859-8.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\iso-8859-9.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\koi8-r.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\windows-1250.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\windows-1251.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\windows-1252.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\windows-1255.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\x-euc-jp-jisx0221.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\x-euc-jp-unicode.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\x-sjis-cp932.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\x-sjis-jdk117.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\x-sjis-jisx0221.enc"
  File "${C_PERL_DIR}\lib\XML\Parser\Encodings\x-sjis-unicode.enc"

  SetOutPath "$G_MPLIBDIR\XML\Parser\Style"
  File "${C_PERL_DIR}\lib\XML\Parser\Style\Debug.pm"
  File "${C_PERL_DIR}\lib\XML\Parser\Style\Objects.pm"
  File "${C_PERL_DIR}\lib\XML\Parser\Style\Stream.pm"
  File "${C_PERL_DIR}\lib\XML\Parser\Style\Subs.pm"
  File "${C_PERL_DIR}\lib\XML\Parser\Style\Tree.pm"
