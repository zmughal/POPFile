...
# Slovak-pfi.nsh
#
# This file contains the "Slovak" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Kliknite na œalej pre pokraËovanie"
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Chyst·te sa nainötalovaù POPFile na svoj poËÌtaË.${IO_NL}${IO_NL}Pred zaËiatkom inötal·cie je odpor˙ËanÈ zavrieù vöetky ostatnÈ aplik·cie.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "Odstr·niù"
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_CONTINUE      "PokraËovanie"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "N·zvy koöov mÙûu obsahovaù len znaky od a do z (malÈ pÌsmo) plus - a _"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile UûÌvateæskÈ rozhranie"
