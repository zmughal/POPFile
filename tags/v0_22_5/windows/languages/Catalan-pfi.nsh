...
# Catalan-pfi.nsh
#
# This file contains the "Catalan" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Aquest assistent el guiarà durant el procés d'instal·lació de POPFile.${IO_NL}${IO_NL}Es recomana tancar tota la resta d'aplicacions abans de començar la Instal·lació.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "Suprimir"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Els noms de cistella només poden contenir lletres a a z en minúscules, números 0 a 9, més - i _"
