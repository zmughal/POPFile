...
# Danish-pfi.nsh
#
# This file contains the "Danish" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Tryk næste for at fortsætte"
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Dette vil installere POPFile på din computer.${IO_NL}${IO_NL}det foretrækkes at du lukker alle kørende programmer inden start af guiden.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_CONTINUE      "Fortsætte"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Spandenes navne kan kun indholde bogstaverne a til z med små bogstaver, samt - og _"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile Kontrolcenter"
