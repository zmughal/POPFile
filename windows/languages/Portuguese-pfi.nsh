...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Este assistente ajudá-lo-á durante a instalação do POPFile.${IO_NL}${IO_NL}É recomendado que feche todas as outras aplicações antes de iniciar a Instalação.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Nomes de receptáculos apenas podem conter as letras de a até z minúsculas mais - e _"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile Interface do Utilizador"
