...
# Russian-pfi.nsh
#
# This file contains the "Russian" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Õ‡ÊÏËÚÂ ƒ‡ÎÂÂ ‰Îˇ ÔÓ‰ÓÎÊÂÌËˇ ÛÒÚ‡ÌÓ‚ÍË."
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "›Ú‡ ÔÓ„‡ÏÏ‡ ÛÒÚ‡ÌÓ‚ËÚ POPFile Ì‡ ¬‡¯ ÍÓÏÔ¸˛ÚÂ.${IO_NL}${IO_NL}œÂÂ‰ ÔÓ‰ÓÎÊÂÌËÂÏ ÛÒÚ‡ÌÓ‚ÍË, ÂÍÓÏÂÌ‰ÛÂÚÒˇ Á‡Í˚Ú¸ ‚ÒÂ Á‡ÔÛ˘ÂÌÌ˚Â ÔËÎÓÊÂÌËˇ.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "ıƒ¡Ã…‘ÿ"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Ó¡⁄◊¡Œ…≈ ◊≈ƒ“¡ Õœ÷≈‘ ”œ”‘œ—‘ÿ …⁄ ”‘“œﬁŒŸ»Ã¡‘…Œ”À…» ¬’À◊ œ‘ 'a' ƒœ 'z' … ⁄Œ¡Àœ◊ - … _"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile ˜≈¬-…Œ‘≈“∆≈ ”"
