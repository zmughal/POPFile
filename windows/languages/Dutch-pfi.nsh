...
# Dutch-pfi.nsh
#
# This file contains the "Dutch" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Klik op Volgende om verder te gaan"
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Deze wizard zal POPFile op uw systeem installeren.${IO_NL}${IO_NL}Het is aanbevolen dat u alle andere programma's afsluit voordat u Setup start.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "Verwijder"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Baknamen kunnen alleen a t/m z (geen hoofdletters) en - en _ karakters bevatten"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile Gebruikers Interface"
