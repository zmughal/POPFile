...
# TradChinese-pfi.nsh
#
# This file contains the "TradChinese" text strings used by the Windows installer
...
; 'Traditional Chinese' translation not available for POPFile, use the default NSIS 'Traditional Chinese' WELCOME message instead
; The English version of the default NSIS WELCOME message is:
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "這將會在你的電腦，安裝 POPFile 。${IO_NL}${IO_NL}在開始安裝之前，建議先關閉其他所有應用程式。這將允許\「安裝程式」更新指定的系統檔案，而不需要重新啟動你的電腦。${IO_NL}${IO_NL}$_CLICK"
