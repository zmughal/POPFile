...
# Swedish-pfi.nsh
#
# This file contains the "Swedish" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Klicka Nästa för att fortsätta"
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Denna guide tar dig igenom installationen av POPFile.${IO_NL}${IO_NL}Det är rekomenderat att du avslutar alla program innan du fortsätter installationen.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "Ta bort"
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_CONTINUE      "Fortsätta"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Hinkens namn kan bara innehålla bokstäverna a till z (små bokstäver) samt - och _"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile Gränssnitt"
