...
# Turkish-pfi.nsh
#
# This file contains the "Turkish" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Devam'a tiklayin."
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Bu sihirbaz size POPFile kurulumu boyunca rehberlik edecektir.${IO_NL}${IO_NL}Kurulumu baslatmadan önce çalisan diger programlari kapatmanizi öneririz.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "Kaldýr"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Kategori adlarý sadece a'dan z'ye küçük harfleri, 0'dan 9'a sayýlarý,  artý - ve _ karakterlerini içerebilir"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile Kullanýcý arayüzü web portu"
