...
; Section "-Minimal Perl" SecMinPerl
  ...
  File "${C_PERL_DIR}\site\lib\Cwd.pm"
        SetOutPath "$G_MPLIBDIR\auto\Cwd"
        File "${C_PERL_DIR}\site\lib\auto\Cwd\Cwd.dll"
        SetOutPath "$G_MPLIBDIR"
  ...
  File "${C_PERL_DIR}\site\lib\File\Spec.pm"
        SetOutPath "$G_MPLIBDIR\auto\File\Glob"
        File "${C_PERL_DIR}\lib\auto\File\Glob\Glob.dll"

  SetOutPath "$G_MPLIBDIR\File\Spec"
  File "${C_PERL_DIR}\site\lib\File\Spec\Unix.pm"
  File "${C_PERL_DIR}\site\lib\File\Spec\Win32.pm"
