...
# Finnish-pfi.nsh
#
# This file contains the "Finnish" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "T‰m‰ avustaja ohjaa sinut ohjelman POPFile asennuksen l‰pi.${IO_NL}${IO_NL}On suositeltavaa sulkea kaikki muut ohjelmat ennen Asennuksen k‰ynnist‰mist‰, sill‰ silloin Asennus voi p‰ivitt‰‰ tiettyj‰ j‰rjestelm‰tiedostoja k‰ynnist‰m‰tt‰ konetta uudelleen.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "Poista"
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_CONTINUE      "Jatkaaksesi"
