...
# Italian-pfi.nsh
#
# This file contains the "Italian" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Seleziona Seguente per continuare"
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Questo programma installerà POPFile nel vostro computer.${IO_NL}${IO_NL}Si raccomanda di chiudere tutte le vostre applicazioni, prima di iniziare l'installazione.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "Rimuovi"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "I nomi dei cesti possono contenere solo lettere minuscole dalla a alla z ed i segni - e _"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile Porta dell'interfaccia utente web"
