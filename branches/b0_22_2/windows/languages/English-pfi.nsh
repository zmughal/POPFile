...
# English-pfi.nsh
#
# This file contains the "English" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "This wizard will guide you through the installation of POPFile.${IO_NL}${IO_NL}It is recommended that you close all other applications before starting Setup.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_UN_IO_MODE_LABEL     "(e.g. change the Nihongo parser)"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_CREATE        "${IO_NL}Create a new bucket by either selecting a name from the list below or typing a name of your own choice."
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_DELETE        "${IO_NL}To delete one or more buckets from the list, tick the relevant 'Remove' box(es) then click the 'Continue' button."
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_MSG_A         "${IO_NL}There is no need to add more buckets"
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_MSG_B         "${IO_NL}You must define AT LEAST TWO buckets"
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_MSG_C         "${IO_NL}At least one more bucket is required"
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_MSG_D         "${IO_NL}Installer cannot create more than $G_PLS_FIELD_1 buckets"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Bucket names can only contain the letters a to z in lower case, numbers 0 to 9,  plus - and _"
