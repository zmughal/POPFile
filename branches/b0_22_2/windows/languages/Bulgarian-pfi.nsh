...
# Bulgarian-pfi.nsh
#
# This file contains the "Bulgarian" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Натиснете 'Напред', за да продължите."
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Той ще инсталира POPFile на вашия компютър.${IO_NL}${IO_NL}Препоръчва се да затворите всички други приложения, преди да стартирате инсталацията.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "Премахни"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Имената на кошовете може да съдържат само малки латински букви от a до z плюс знаците - и _"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile Потребителски интерфейс"
