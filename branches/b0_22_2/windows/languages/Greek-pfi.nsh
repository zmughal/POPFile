...
# Greek-pfi.nsh
#
# This file contains the "Greek" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Κάντε κλικ στο Επόμενο για να συνεχίσετε"
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Ο οδηγός αυτός θα σας καθοδηγήσει κατά τη διάρκεια της εγκατάστασης του 'POPFile'.${IO_NL}${IO_NL}Συνιστάται να κλείσετε όλες τις άλλες εφαρμογές πριν ξεκινήσετε την Εγκατάσταση.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "Απαλοιφή"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Τα ονόματα των αρχείων μπορούν να περιέχουν μόνο τα πεζά αγγλικά γράμματα  a έως z, τους αριθμούς 0 εως 9,  και τους χαρακτήρες  - και _"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "Επιφάνεια Ελέγχου POPFile"
