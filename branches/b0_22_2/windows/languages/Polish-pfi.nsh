...
# Polish-pfi.nsh
#
# This file contains the "Polish" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Kliknij Dalej aby kontynuowaæ"
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Ten kreator pomo¿e Ci zainstalowaæ program POPFile.${IO_NL}${IO_NL}Zalecamy, byœ zamkn¹³ wszystkie uruchomione programy zanim rozpoczniesz instalacjê.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "Usuñ"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Nazwy folderów mog± zawieraæ tylko ma³e litery od a do z, cyfry 0 do 9,  oraz - i _"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile Interface u¿ytkownika"
