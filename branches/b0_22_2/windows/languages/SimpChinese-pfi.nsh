...
# SimpChinese-pfi.nsh
#
# This file contains the "SimpChinese" text strings used by the Windows installer
...
; 'Simplified Chinese' translation not available for POPFile, use the default NSIS 'Simplified Chinese' WELCOME message instead
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "这将会在你的计算机，安装 POPFile 。${IO_NL}${IO_NL}在开始安装之前，建议先关闭其他所有应用程序。这将允许“安装程序”更新指定的系统文件，而不需要重新启动你的计算机。${IO_NL}${IO_NL}$_CLICK"
