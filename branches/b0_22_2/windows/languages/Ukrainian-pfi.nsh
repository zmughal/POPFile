...
# Ukrainian-pfi.nsh
#
# This file contains the "Ukrainian" text strings used by the Windows installer
...
!insertmacro PFI_LANG_STRING PFI_LANG_INST_PROG_ENDSEC     "Õ‡ÚËÒÌ≥Ú¸ ƒ‡Î≥ ‰Îˇ ÔÓ‰Ó‚ÊÂÌÌˇ"
...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "ƒ‡Ì‡ ÛÒÚ‡ÌÓ‚Í‡ ‚ÒÚ‡ÌÓ‚ËÚ¸ POPFile Ì‡ ‚‡¯ ÍÓÏÔ'˛ÚÂ.${IO_NL}${IO_NL}–ÂÍÓÏÂÌ‰Ó‚‡ÌÓ Á‡ÍËÚË ‚Ò≥ ÔÓ„‡ÏË ÔÂÂ‰ ÔÓ˜‡ÚÍÓÏ ≥ÌÒÚ‡Îˇˆ≥ø.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_REMOVE        "˜…Ã’ﬁ…‘…"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "∂Õ≈Œ¡ À¡‘≈«œ“¶  Õœ÷’‘ÿ Õ¶”‘…‘… ‘¶ÃÿÀ… Õ¡Ã¶ Ã¶‘≈“… ◊¶ƒ a ƒœ z ‘¡ - ¶ _"
...
!insertmacro PFI_LANG_STRING PFI_LANG_FINISH_RUN_TEXT      "POPFile ∂Œ‘≈“∆≈ ” Àœ“…”‘’◊¡ﬁ¡"
