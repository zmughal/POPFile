...
!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "Chystáte se nainstalovat POPFile na svùj poèítaè.${IO_NL}${IO_NL}Pøed zaèátkem instalace je doporuèeno zavøít všechny ostatní aplikace.${IO_NL}${IO_NL}$_CLICK"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_B       "Názvy košù mùžou obsahovat jen znaky od a do z (malé písmo) plus - a _"
